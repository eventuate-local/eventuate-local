...
@SpringApplicationConfiguration(classes = MySqlBinLogBasedEventTableChangesToAggregateTopicRelayEmptyEventuateDBTest.EventTableChangesToAggregateTopicRelayTestConfiguration.class)
@DirtiesContext
@IntegrationTest
