...
public abstract class AbstractMySqlBinlogCdcPipelineReaderFactory extends CommonDbLogCdcPipelineReaderFactory<MySqlBinlogCdcPipelineReaderProperties, MySqlBinaryLogClient> {
  public static final String TYPE = "mysql-binlog";

  public AbstractMySqlBinlogCdcPipelineReaderFactory(CuratorFramework curatorFramework,
  ...
  public MySqlBinaryLogClient create(MySqlBinlogCdcPipelineReaderProperties mySqlBinlogCdcPipelineReaderProperties) {
    ...
    return new MySqlBinaryLogClient(mySqlBinlogCdcPipelineReaderProperties.getCdcDbUserName(),
            ...
            createOffsetStore(mySqlBinlogCdcPipelineReaderProperties,
                    dataSource,
