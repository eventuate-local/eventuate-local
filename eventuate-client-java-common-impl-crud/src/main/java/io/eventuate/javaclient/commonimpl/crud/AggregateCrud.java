...
public interface AggregateCrud {
  ...
  CompletableFuture<EntityIdVersionAndEventIds> update(EntityIdAndType entityIdAndType, List<EventTypeAndData> events, Optional<AggregateCrudUpdateOptions> updateOptions);
}
