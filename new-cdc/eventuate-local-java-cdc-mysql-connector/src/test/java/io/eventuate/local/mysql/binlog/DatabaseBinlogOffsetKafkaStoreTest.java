...
public class DatabaseBinlogOffsetKafkaStoreTest extends AbstractCdcTest{
  ...
  public void shouldWorkCorrectlyWithMultipleDifferentNamedBinlogs() throws InterruptedException {
    floodTopic(mySqlBinaryLogClientConfigurationProperties.getDbHistoryTopicName(), "mySqlBinaryLogClientName1");
  ...
  private BinlogFileOffset generateAndSaveBinlogFileOffset() throws InterruptedException {
    ...
    DatabaseBinlogOffsetKafkaStore binlogOffsetKafkaStore = getDatabaseBinlogOffsetKafkaStore(mySqlBinaryLogClientConfigurationProperties.getDbHistoryTopicName(), "mySqlBinaryLogClientName");
