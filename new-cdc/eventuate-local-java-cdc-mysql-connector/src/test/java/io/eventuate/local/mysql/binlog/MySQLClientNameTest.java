...
public class MySQLClientNameTest extends AbstractCdcTest {
  ...
  @Autowired
  private MySqlBinaryLogClientConfigurationProperties eventuateConfigurationProperties;
  ...
  public void test() throws Exception {
    ...
    MySQLCdcProcessor<PublishedEvent> cdcProcessor = createMySQLCdcProcessor();
  ...
  private MySQLCdcProcessor<PublishedEvent> createMySQLCdcProcessor() throws IOException, TimeoutException{
    MySqlBinaryLogClient<PublishedEvent> mySqlBinaryLogClient = createMySqlBinaryLogClient();
