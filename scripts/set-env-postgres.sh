...
export EVENTUATELOCAL_CDC_POLLING_REQUEST_PERIOD_IN_MILLISECONDS=4000
export EVENTUATELOCAL_CDC_MAX_ATTEMPTS_FOR_POLLING=10
export EVENTUATELOCAL_CDC_DELAY_PER_POLLING_ATTEMPT_IN_MILLISECONDS=2000
